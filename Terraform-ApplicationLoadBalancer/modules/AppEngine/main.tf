...
# resource "google_app_engine_standard_app_version" "backendapplication_v1" {
#   version_id = "v1"
#   service    = var.service
#   runtime    = "nodejs16"
...
#   deployment {
#     zip {
#       source_url = "https://storage.googleapis.com/backendnodecode/nodejsproject.zip"
#     }
#   }
...
#   delete_service_on_destroy = true
#   service_account = "appengine-service-account@fifth-reality-404012.iam.gserviceaccount.com"
